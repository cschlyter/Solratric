...
public class TShape extends Shape
{
	...
	public TShape() {
		...
		tColor = new Color(160, 0, 240, 200);
		...
		// 0 0 0 0
		// 0 0 0 0
		pieceRepresentation[0] = new Block[] { null, null, blocks[0], null };
	...
	public boolean canRotateLeft(Block[][] boardMatrix) {
		...
		case NORMAL:
			...
			return canMove;
		case LEFT:
			canMove = checkCanMove(boardMatrix, 0, -1, 0, 2, 1, -1, 0, 1);
			return canMove;
		case DOWN:
