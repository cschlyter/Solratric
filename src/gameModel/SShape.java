...
//		0 0 0 0
//		0 0 0 0
		pieceRepresentation[0] = new Block[] { null, null, blocks[2], blocks[3]};
		pieceRepresentation[1] = new Block[] { null, blocks[0], blocks[1], null };
	...
	public boolean canRotateLeft(Block[][] boardMatrix) {
		...
		case NORMAL:
			canMove = checkCanMove(boardMatrix, 0, -1, 1, 0, 1, 0, 1, 0);
			return canMove;
		case LEFT:
			canMove = checkCanMove(boardMatrix, 1, -1, 0, 2, 1, -1, 0, 1);
			return canMove;
		case DOWN:
			canMove = checkCanMove(boardMatrix, -1, 0, -1, 0, 0, 2, 1, 0);
			return canMove;
		case RIGHT:
			canMove = checkCanMove(boardMatrix, 0, -1, -1, 1, 0, -2, 0, -1);
			return canMove;
